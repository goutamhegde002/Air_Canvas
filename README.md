...
1. **Clone the Repository**:
   ```bash
   git clone https://github.com/goutamhegde002/air-canvas.git
   cd air-canvas
...
Contributions are welcome! If you have any suggestions or want to collaborate, feel free to submit a pull request or reach out.
